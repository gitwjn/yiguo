...
<body>
                 ...
                 <form action="<?php echo U('Admin/Admin/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>所有权限:<input name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($res)): foreach($res as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="edit"><?php echo ($vo["name"]); ?></td>
                            <td class="edit"><?php echo ($vo["name"]); ?></td>
                            <td>
                              <?php if(($vo["sex"] == 1) ): ?>男
                                <?php elseif($vo['sex'] == 2): ?>
                            ...
                            <?php if(($vo['boss'] == 0) ): ?><td>
                              ...
                              <a href="<?php echo U('Admin/Admin/save',array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle" type="button"><i class="fa fa-list"></i></a>
                            </td><?php endif; ?>
  ...
  <script type="text/javascript" src="/Public/Admin/js/jquery-1.8.3.min.js"></script>
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Admin/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
