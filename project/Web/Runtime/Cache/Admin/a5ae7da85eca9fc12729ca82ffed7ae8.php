                 ...
                 <form action="<?php echo U('Admin/User/index');?>" method="get">
                  ...
                  <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                      <label>用户名:<input name="keyword" type="search" class="form-control input-sm" placeholder="" aria-controls="dataTables-example"></label>
                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 200px;" aria-label="Engine version: activate to sort column ascending">个人简介</th>
                      ...
                      <tbody>
                        <?php if(is_array($res)): foreach($res as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="edit"><?php echo ($vo["username"]); ?></td>
                            <td>
                              <?php if(($vo["sex"] == 1) ): ?>男
                                <?php elseif($vo['sex'] == 2): ?>
                                不详
                            ...
                            <td class="center"><?php echo ($vo["intro"]); ?></td>
                            <td class="center">
